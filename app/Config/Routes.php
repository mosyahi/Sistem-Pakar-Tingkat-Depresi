...
$routes->group('admin', ['filter' => 'auth'], function ($routes) {
    ...
    $routes->get('master_google', 'GoogleController::index');
    $routes->match(['delete'], 'master_google/(:num)', 'GoogleController::delete/$1');
    $routes->get('master_google/truncateDataGoogle', 'GoogleController::truncateDataGoogle');
