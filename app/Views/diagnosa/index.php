					...
					<form id="formDiagnosa" action="<?= base_url('mahasiswa/hasil_diagnosa') ?>" method="post">
						...
						<div id="step2">
							...
							<div class="card-body">
								...
								<div class="form-group mt-4">
									<label class="mb-2">Apakah ada masalah berikut yang menggambarkan anda sekarang?</label>
									<div class="form-check">
										<input class="form-check-input" type="checkbox" name="p_4[]" id="masalah_1" value="Tidak Ada">
										<label class="form-check-label" for="masalah_1">Tidak Ada</label>
									</div>
									<div class="form-check">
										<input class="form-check-input" type="checkbox" name="p_4[]" id="masalah_2" value="Masalah pembayaran kuliah">
										<label class="form-check-label" for="masalah_2">Masalah pembayaran kuliah</label>
									</div>
									<div class="form-check">
										<input class="form-check-input" type="checkbox" name="p_4[]" id="masalah_3" value="Tuntutan Tinggi Mengenai Akademik">
										<label class="form-check-label" for="masalah_3">Tuntutan Tinggi Mengenai Akademik</label>
									</div>
									<div class="form-check">
										<input class="form-check-input" type="checkbox" name="p_4[]" id="masalah_4" value="Tekanan Skripsi">
										<label class="form-check-label" for="masalah_3">Tekanan Skripsi</label>
									</div>
									<div class="form-check">
										<input class="form-check-input" type="checkbox" name="p_4[]" id="masalah_5" value="Tekanan Dari Dosen Pembimbing">
										<label class="form-check-label" for="masalah_3">Tekanan Dari Dosen Pembimbing</label>
									</div>
									<div class="form-check">
										<input class="form-check-input" type="checkbox" name="p_4[]" id="masalah_6" value="Memakai Zat Berbahaya">
										<label class="form-check-label" for="masalah_3">Memakai Zat Berbahaya</label>
									</div>
									<div class="form-check">
										<input class="form-check-input" type="checkbox" name="p_4[]" id="masalah_7" value="Korban Bullying">
										<label class="form-check-label" for="masalah_3">Korban Bullying</label>
									</div>
									<div class="form-check">
										<input class="form-check-input" type="checkbox" name="p_4[]" id="masalah_8" value="Mengalami SP/Mengulang Mata Kuliah Yang Terlalu Banyak">
										<label class="form-check-label" for="masalah_3">Mengalami SP/Mengulang Mata Kuliah Yang Terlalu Banyak</label>
									</div>
								</div>
								<div class="form-group mt-4">
														...
														<tbody>
															...
															<?php foreach ($result as $gejala) : ?>
																<tr>
																	...
																	<td>
																		<select class="btn btn-outline-danger btn-sm" name="cf[]" required>
																			<option selected disabled>Pilih</option>
