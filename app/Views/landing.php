...
<header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
        ...
        <h5 class="logo me-auto" style="font-size: 20px;">
            <img src="public/img/umc.png" class="mb-1" style="height: 28px; width: 28px;" alt="">
...
<section id="hero" class="d-flex align-items-center">
    ...
    <div class="container">
        ...
        <div class="col-lg-4 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
            <img src="public/img/umc.png" class="img-fluid animated"
...
<div class="toast-container position-fixed bottom-0 end-0 p-3">
    <div id="liveToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="toast-header">
            <img src="public/img/umc.png" width="17px" height="17px" class="rounded me-2" alt="...">
